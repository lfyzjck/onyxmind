...
class OpencodeService {
    ...
    async sendPrompt(sessionId: string, prompt: PromptRequest): Promise<AsyncIterator<PromptResponse>>;
...
class ChatView extends ItemView {
    ...
    private handleStreamResponse(stream: AsyncIterator<PromptResponse>): Promise<void>;
